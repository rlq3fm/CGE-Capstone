...
$Sectors:
yd(i)                  !activity level for domestic production
ya(i)                  !activity level for armington production
ye(i)$exp0(i)                  !activity level for export production
...
pd(i)                  !domestic price inex for goods

pm(i)$(-ximp0(i))                   !price inex for import goods
pe(i)$(exp0(i))                   !price inex for export goods
pfx(i)$nx0(i)                  !price index for trade deficit

pa_c(fe,i)$(int0(fe,i)*aeei(i)*(1-r_feed(fe,i)))               !domestic price inex for energy goods include carbon emission
...
$prod:yd(i)$elec(i)   s:esub_gt   a:esub_pe     c(a):esub_be
        o:pd(i)                               q:output0(i)
...
*// other sectors
$prod:yd(i)$(not elec(i)) s:esub("TOP",i) a:esub("NR",i) b(a):esub("IT",i)  kle(b):esub("KLE",i) kl(kle):esub("KL",i) e(kle):esub("E",i)  ne(e):esub("NELE",i)
        o:pd(i)                             q:(output0(i))                    p:(1-tx0(i))     a:ra    t:tx0(i)
...
$prod:ya(i) s:1
        o:pa(i)                             q:a0(i)
        i:pd(i)                             q:output0(i)
        i:pm(i)$(-ximp0(i))                             q:(-ximp0(i))

*// export index
$prod:ye(i)$exp0(i) s:0
        o:pe(i)                             q:exp0(i)
        i:pa(i)                             q:exp0(i)
...
e:pfx(i)             q:(-(nx0(i))*xscale)
e:pa(i)              q:(-(xinv0(i)+xcons0(i)))
...
$demand:raf
d:pe(i)$(exp0(i))       q:exp0(i)
d:pfx(i)$nx0(i)         q:(-(nx0(i))*xscale)
e:pm(i)$(-ximp0(i))     q:(-ximp0(i))
...
$constraint:rgdp
        pu*rgdp =e= pcons*sum(i,cons0(i))*consum
              ...
              +sum(i,pd(i)*((nx0(i)+xinv0(i)+xcons0(i))*xscale));
...
v:qdout(j)             o:pd(j)       prod:y(j)     !output by sector(domestic market)

v:qc(i)                i:pa(i)       prod:consum   !consumpiton of final commodities
v:grosscons            o:pcons       prod:consum   !aggregate consumpiton

v:qinvk(i)             i:pa(i)       prod:invest   !physical capital investment by non-energy sectors
v:grossinvk            o:pinv        prod:invest   !aggregate physical capital investment

v:util                 o:pu          prod:welf       !welf

v:qin(i,j)             i:pa(i)       prod:y(j)      !inputs of intermediate goods
v:qin_ele(i,sub_elec)  i:pa(i)       prod:yelec(sub_elec)      !inputs of intermediate goods to fossil fuel fired generation

v:qein(fe,i)             i:pa(fe)       prod:yco2_i(fe,i)      !inputs of fossil energy goods
v:qec(fe)                i:pa(fe)       prod:yco2_h(fe)        !consumption of fossil energy goods
